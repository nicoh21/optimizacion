...
//Simpre uso del operador ternario

const pregunta = prompt("¿Desea recibir notificaciones?");

let respuesta = pregunta === "si" ? true : false;
respuesta ? alert("Buenisimoo, recibirá notificaciones") : alert("No recibirá notificaciones");
